...
namespace Microsoft.Teams.EmbeddedChat.Controllers
{
    using System;
    using System.Linq;
    ...
    using global::Azure.Communication;
    ...
    public class MappingController : ControllerBase
    {
        ...
        public async Task<IActionResult> Initalize(string entityId)
        {
            ...
            var token = await client.GetTokenAsync(new CommunicationUserIdentifier(mapping.AcsUserId), scopes: new [] { CommunicationTokenScope.Chat });
