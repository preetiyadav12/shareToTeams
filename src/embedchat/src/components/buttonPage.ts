...
template.innerHTML = `
<div class="teams-embed-button-container">
    <div>
        <button class="teams-embed-button">
            <img class="teams-embed-button-img" alt="Microsoft Teams" />
            <span class="teams-embed-button-text"></span>
        </button>
    </div>
</div>`;
...
export class ButtonPage extends HTMLElement {
    ...
    render() {
        ...
        (<HTMLImageElement>container.querySelector(".teams-embed-button-img")).src = teamsIcon;
        (<HTMLElement>container.querySelector(".teams-embed-button-text")).innerText = this.text;
        if (this.callback) {
            (<HTMLElement>container.querySelector(".teams-embed-button")).addEventListener("click", this.callback);
        }
